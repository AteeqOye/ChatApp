...
public class SignUpActivity extends AppCompatActivity {
    ...
    private Boolean isValidSignUpDetails()
    {
        ...
        //Sometimes you would want to remove only the spaces at the beginning or end of the String (not the ones in the middle).
        // If that's the case you can use trim:
